...
${DIM}  1) npx @superkut/subagents find [query]${RESET}
${DIM}  2) npx @superkut/subagents add <owner/repo@agent-name>${RESET}`;
  ...
  if (query) {
    ...
    console.log(`${DIM}Install with${RESET} npx @superkut/subagents add <owner/repo@agent-name>`);
    console.log();
