...
${DIM}  1) npx @superkut/get-subagents find [query]${RESET}
${DIM}  2) npx @superkut/get-subagents add <owner/repo@agent-name>${RESET}`;
  ...
  if (query) {
    ...
    console.log(
      `${DIM}Install with${RESET} npx @superkut/get-subagents add <owner/repo@agent-name>`
    );
    console.log();
